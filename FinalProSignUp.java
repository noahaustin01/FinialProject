 ...
 * @author jesse
 */
public class FinalProSignUp extends javax.swing.JFrame {

    /**
     * Creates new form FinalProSignUp
     */
    public FinalProSignUp() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Password must contain a capital letter, a number ");
        ...
        jLabel1.setText("Sign up, its free");
        ...
        BtnExitSignUp.setBackground(new java.awt.Color(0, 0, 0));
        BtnExitSignUp.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        ...
        jLabel7.setText("Password must contain a capital letter,");

        jLabel8.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel8.setText("a number, and have at least 8 characters");
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                            ...
                                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                                .addComponent(TxtConfirmPass, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addComponent(TxtSetPass, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addComponent(TxtSetUser, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(jLabel2)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(TxtSetUser, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(12, 12, 12)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4)
                    .addComponent(jLabel7))
...
//        This section checks to make sure that your password is secure enough it also saves it to a file for future use 
        ...
        if (!TxtSetUser.equals("")) {
            letts = TxtSetPass.getText();
            if (letts.length() >= 8) {
                ...
                if (passGood && TxtConfirmPass.getText().equals(TxtSetPass.getText())) {
                    FinalProLogin login = new FinalProLogin();
                    try {
                        BufferedWriter buff = new BufferedWriter(new FileWriter("loginInfo.txt"));
                        buff.write(TxtSetUser.getText() + "\n");
                        buff.write(TxtSetPass.getText() + "\n");
                        buff.close();
                    } catch (Exception e) {
                ...
                } else if (passGood && !TxtConfirmPass.getText().equals(TxtSetPass.getText())) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FinalProSignUp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FinalProSignUp().setVisible(true);
            }
        });
    }
